...
class TestmonialController extends Controller
{
    ...
    public function store(StoreTestmonialRequest $request)
    {
        ...
        return to_route('admin.testmonials.index')->with('success', __('keywords.create_success'));
    }
    ...
    public function update(UpdateTestmonialRequest $request, Testmonial $testmonial)
    {
        ...
        return to_route('admin.testmonials.index')->with('success', __('keywords.update_success'));
    }
    ...
    public function destroy(Testmonial $testmonial)
    {
        Storage::delete("public/testmonials/$testmonial->image");
        $testmonial->delete();
        return to_route('admin.testmonials.index')->with('success', __('keywords.delete_success'));
    }
}
