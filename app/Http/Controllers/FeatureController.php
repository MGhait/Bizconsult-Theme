...
class FeatureController extends Controller
{
    ...
    public function store(StoreFeatureRequest $request)
    {
        ...
        Feature::create($data);
        return to_route('admin.features.index')->with('success', __('keywords.create_success'));
    }
    ...
    public function update(UpdateFeatureRequest $request, Feature $feature)
    {
        $data = $request->validated();
        $feature->update($data);
        return to_route('admin.features.index')->with('success', __('keywords.update_success'));
    }
    ...
    {
        $feature->delete();
        return to_route('admin.features.index')->with('success', __('keywords.delete_success'));
    }
}
