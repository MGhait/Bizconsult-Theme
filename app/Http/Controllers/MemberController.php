...
class MemberController extends Controller
{
    ...
    public function store(StoreMemberRequest $request)
    {
        ...
        Member::create($data);
        return to_route('admin.members.index')->with('success', __('keywords.create_success'));
    }
    ...
    public function update(UpdateMemberRequest $request, Member $member)
    {
        ...
        $member->update($data);
        return to_route('admin.members.index')->with('success', __('keywords.update_success'));
    }
    ...
    public function destroy(Member $member)
    {
        ...
        $member->delete();
        return to_route('admin.members.index')->with('success', __('keywords.delete_success'));
    }
}
