                ...
                <form method="POST" action="{{ route('admin.services.update', ['service' => $service]) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="{{ __('keywords.title') }}" value="{{ $service->title }}">
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <textarea class="form-control" name="description" placeholder="{{ __('keywords.description') }}">{{ $service->description }}</textarea>
