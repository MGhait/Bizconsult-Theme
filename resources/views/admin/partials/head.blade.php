...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin' . $dir) }}/css/select2.css">
    <link rel="stylesheet" href="{{ asset('admin' . $dir) }}/css/dropzone.css">
    <link rel="stylesheet" href="{{ asset('admin' . $dir) }}/css/uppy.min.css">
    <link rel="stylesheet" href="{{ asset('admin' . $dir) }}/css/jquery.steps.css">
    <link rel="stylesheet" href="{{ asset('admin' . $dir) }}/css/jquery.timepicker.css">
    <link rel="stylesheet" href="{{ asset('admin' . $dir) }}/css/quill.snow.css">
